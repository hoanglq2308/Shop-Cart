...
public class CartSecurityTest {
     ...
     * Mô phỏng: Kẻ tấn công truy cập đổi số lượng Item trong giỏ hàng (cartItemId = 2) 
     * của người khác mà không có bất kỳ chứng thực nào (Authorization là null hoặc user ảo).
     ...
     * Mô phỏng: Gửi Fake Request POST từ site độc hại (Attacker) đến thêm sản phẩm vào giỏ.
